    ...
    <>
      ...
      <div className="dash_InteriorDesign">
        ...
        <div className="dash_interiorDesignForm">
          <div
            className="TryDesignDiv"
            style={{
              padding: "0px",
              backgroundColor: "#43484b00",
              marginTop: "30px",
            }}
          >
              ...
              <>
                <div>
                  ...
                  <Select
                    ...
                    options={
                      // activeTab == 1
                      //   ? maskCategoriesForInt
                      //   : maskCategoriesForExt
                      mask_categories
                    }
                    styles={customStyles}
                    isSearchable={false}
          ...
          <div className="dash_interiorDesignFirst">
            ...
            <div
              className="dash_interiorDesignThird"
          ...
          {masks.length > 0 ? (
            <>
              ...
              <div className="mask-images flex-container">
